...
const colorKeywords = require('./keywordColor.js')
...
const question = [
    ...
    // ****SHAPE COLOR***
    // user choose color keyword or hexadecimal for color of shape
    {
    ...
    // user choose color keyword or hexadecimal for color of text
    {
